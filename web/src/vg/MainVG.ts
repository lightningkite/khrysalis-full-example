...
import { EntryPoint, HasBackAction, HasBackActionDefaults, StackSubject, ViewGenerator, onThrottledEventDo, showInSwap, subscribeAutoDispose, viewVisible, xStackPop, xStackPush } from 'rxjs-plus'
...
export class MainVG implements ViewGenerator, EntryPoint {
    ...
    public generate(dependency: Window): HTMLElement {
        ...
        this.stack.pipe(map((it: Array<ViewGenerator>): string => ((): (string | null) => {
            const temp237 = (takeLastOr(null, it)!?.titleString ?? null);
