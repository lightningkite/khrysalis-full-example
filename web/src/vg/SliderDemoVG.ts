...
import { ViewGenerator, bind, mapSubject, subscribeAutoDispose } from '@lightningkite/rxjs-plus'
import { BehaviorSubject, Subject } from 'rxjs'

//! Declares com.lightningkite.rxexample.vg.SliderDemoVG
export class SliderDemoVG implements ViewGenerator, HasTitle {
    ...
    //! Declares com.lightningkite.rxexample.vg.SliderDemoVG.title
