...
export class SelectDemoVG implements ViewGenerator, HasTitle {
    ...
    public constructor(public readonly stack: StackSubject<ViewGenerator>) {
        this.options = [new ExampleContentVG(), new VideoDemoVG(), new WebsocketDemoVG(), new HttpDemoVG(), new ExternalTestVG(), new DateButtonDemoVG(), new LocationDemoVG(), new LoginDemoVG(this.stack), new LoadImageDemoVG(), new ControlsDemoVG(), new ViewPagerDemoVG(this.stack), new SliderDemoVG()];
    }
    
    //! Declares com.lightningkite.rxexample.vg.SelectDemoVG.title
    ...
    public generate(dependency: Window): HTMLElement {
        ...
        of(this.options).pipe(showIn(xml.list, (obs: Observable<ViewGenerator>): HTMLElement => {
            ...
            obs.pipe(subscribeAutoDispose(xml.label, (this_: HTMLElement, it: ViewGenerator): void => {
                this_.innerText = ((tryCastInterface<HasTitle>(it, "HasTitle"))?.title ?? null) ?? "";
            }));
